...
function Home() {
  return (
    <div className="bg-black absolute h-screen w-screen bg-pattern bg-cover bg-center overflow-hidden">
      <div>
        <div className=" flex items-center justify-center pt-6 text-3xl">
        ...
        <img
          ...
          alt="LearnBot"
          className="absolute top-0 right-20 w-16 h-auto mr-6 mt-0"
        />
      </div>

      <div className="flex justify-center items-center w-full h-full">
        <div className="flex-col items-center ml-72 ">
          <div className="text-[#FFFFFF] text-justify w-[380px] mb-14">
