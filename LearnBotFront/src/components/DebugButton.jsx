...
function DebugButton({ onDebugClick }) {
    return (
        <span
            ...
            className="flex items-center justify-center gap-2 h-9 rounded-[30px] border-[#58b468d0]  border-2 hover:cursor-pointer shadow-lg active:shadow-none hover:bg-[#fdf5ff] opacity-80 px-4 py-2"
