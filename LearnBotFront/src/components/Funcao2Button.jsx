...
function Funcao2Button({ onFuncao2Click }) {
    return (
        <span
            ...
            className="flex items-center justify-center gap-1 h-8 rounded-[30px] border-[#9073e8] border-2 hover:cursor-pointer shadow-lg active:shadow-none hover:bg-[#fdf5ff] opacity-80 px-3 py-2"
